...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <form  method="POST" action="{!! url('client/update' , ['id' => $client->id]) !!}"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $client->name }}" name="name" value="{{ $client->name }}" id="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Companies Hous No. </label>
                                <input type="text" class="form-control" value="{{ $client->company }}" name="company" id="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Telephone No </label>
                                <input type="number" class="form-control" value="{{ $client->tele }}" name="tele"  id="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Email </label>
                                <input type="text" class="form-control" value="{{ $client->email }}" name="email"  id="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Contact </label>
                                <input type="text" class="form-control" value="{{ $client->contact }}" name="contact" id="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Fax  No. </label>
                                <input type="text" class="form-control" value="{{ $client->fax }}" name="fax" id="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Website </label>
                                <input type="text" class="form-control" value="{{ $client->website }}" name="website" id="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Position </label>
                                <input type="text" class="form-control" value="{{ $client->position }}" name="position" id="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Postcode </label>
                                <input type="text" class="form-control" value="{{ $client->postcode }}" name="postcode" id="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="" class="form-label">Address </label>
                                <input type="text" class="form-control" value="{{ $client->address }}" name="address" id="">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question1" id="" style="height: 100px">{{ $client->question1 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question2" id="" style="height: 100px">{{ $client->question2 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question3" id="" style="height: 100px">{{ $client->question3 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question4" id="" style="height: 100px">{{ $client->question4 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question5" id="" style="height: 100px">{{ $client->question5 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question6" id="" style="height: 100px">{{ $client->question6 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question7" id="" style="height: 100px">{{ $client->question7 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question11" id="" style="height: 100px">{{ $client->question11 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question15" id="" style="height: 100px">{{ $client->question15 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question16" id="" style="height: 100px">{{ $client->question16 }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question17" id="" style="height: 100px">{{ $client->question17 }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question18" id="" style="height: 100px">{{ $client->question18 }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="question19" id="" style="height: 100px">{{ $client->question18 }}</textarea>
                            </div>
                        </div>
                    </div>
